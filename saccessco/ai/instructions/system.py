...
SYSTEM_INSTRUCTIONS = (
    ...
    "* Always produce a response that is a jason loadable string with following structure:\n"
    ...
    "** 'use speak, for any message you want to send the user, even in cases there is plan\n"
